    ...
    private val logListener = object : ValueEventListener {
        ...
        override fun onDataChange(dataSnapshot: DataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                ...
                val locationLogging = dataSnapshot.child("StanleyLocation").getValue(LocationModel::class.java)
                ...
                if (partnerLat !=null  && partnerLong != null) {
                    ...
                    marker1 = map.addMarker(MarkerOptions().position(partnerLoc).title("Stanley"))
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                if (locationResult.locations.isNotEmpty()) {
                    ...
                    marker1 = map.addMarker(MarkerOptions().position(latLng).title("Rotimi"))
